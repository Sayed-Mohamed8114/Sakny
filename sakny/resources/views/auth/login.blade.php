<x-guest-layout>
    ...
    <x-text-input id="phone" class="block mt-1 w-full"
                  type="text"
                  name="phone"
                  class="focus:ring-black w-[100%] mt-2"
                  :value="old('phone')"
                  required autofocus />
    <x-input-error :messages="$errors->get('phone')" class="mt-2" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('Password / كلمه السر')" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">{{ __('Remember me / تذكرني') }}</span>
            </label>
        </div>
